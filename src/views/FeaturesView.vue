  ...
  <Layout>
    <div class="flex items-center justify-center">
      <div class="z-20 min-h-screen flex-col overflow-hidden p-4 text-2xl">
        <div class="h-30 bg-gradient-to-r from-purple-500 to-pink-500">
          <div class="carousel w-full">
            <div id="item1" class="carousel-item w-full">
              <img src="public/item1.jpg" class="w-full" />
            </div> 
            <div id="item2" class="carousel-item w-full">
              <img src="public/item2.jpg" class="w-full" />
            </div> 
            <div id="item3" class="carousel-item w-full">
              <img src="public/item3.jpg" class="w-full" />
            </div> 
            <div id="item4" class="carousel-item w-full">
              <img src="public/item4.jpg" class="w-full" />
            </div>
            <div id="item5" class="carousel-item w-full">
              <img src="public/item5.jpg" class="w-full" />
            </div> 
            <div id="item6" class="carousel-item w-full">
              <img src="public/item6.jpg" class="w-full" />
            </div>
          </div> 
        ...
        <section class="bg-dracula dark:bg-gray-900">
  <div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
      <div class="max-w-screen-md mb-8 lg:mb-16">
          <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-dracula">Designed for business teams like yours</h2>
      ...
      <div class="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
          <div>
              ...
              <h3 class="mb-2 text-xl font-bold dark:text-dracula">Marketing</h3>
          ...
          <div>
              ...
              <h3 class="mb-2 text-xl font-bold dark:text-dracula">Legal</h3>
          ...
          <div>
              ...
              <h3 class="mb-2 text-xl font-bold dark:text-dracula">Business Automation</h3>
          ...
          <div>
              ...
              <h3 class="mb-2 text-xl font-bold dark:text-dracula">Finance</h3>
          ...
          <div>
              ...
              <h3 class="mb-2 text-xl font-bold dark:text-dracula">Enterprise Design</h3>
          ...
          <div>
              ...
              <h3 class="mb-2 text-xl font-bold dark:text-dracula">Operations</h3>
