<template>
  ...
  >
    ...
    <div
      class="relative mx-auto my-auto w-full max-w-lg rounded-xl bg-white p-5 shadow-lg"
    >
      <!--content-->
      <div class="">
        <!--body-->
        <div class="flex-auto justify-center p-5 text-center">
          <svg
            ...
            class="-m-1 mx-auto flex h-4 w-4 items-center text-red-500"
            fill="none"
            viewBox="0 0 24 24"
            stroke="currentColor"
          >
          ...
          <svg
            xmlns="http://www.w3.org/2000/svg"
            class="mx-auto flex h-16 w-16 items-center text-red-500"
            viewBox="0 0 20 20"
            fill="currentColor"
          >
            <path
        ...
        <div class="mt-2 space-x-4 p-3 text-center md:block">
          <button
            class="mb-2 rounded-full border bg-white px-5 py-2 text-sm font-medium tracking-wider text-gray-600 shadow-sm hover:bg-gray-100 hover:shadow-lg md:mb-0"
          >
            Cancel
          </button>
          <button
            class="mb-2 rounded-full border border-red-500 bg-red-500 px-5 py-2 text-sm font-medium tracking-wider text-white shadow-sm hover:bg-red-600 hover:shadow-lg md:mb-0"
          >
            Delete
          </button>
        </div>
