...
const onButtonClick = () => hidden.value.click();
  ...
  <div>
    <main class="container mx-auto h-full max-w-screen-lg">
      ...
      >
        ...
        <!-- scroll area -->
        <section class="flex h-full h-full w-full flex-col overflow-auto p-8">
          <header
            class="flex flex-col items-center justify-center border-2 border-dashed border-gray-400 py-12"
          >
            <p
              class="mb-3 flex flex-wrap justify-center font-semibold text-gray-900"
            >
            ...
            <button
              id="button"
              class="focus:shadow-outline mt-2 rounded-sm bg-gray-200 px-3 py-1 hover:bg-gray-300 focus:outline-none"
            >
              Upload a file
            </button>
          </header>
          ...
          <ul id="gallery" class="-m-1 flex flex-1 flex-wrap">
            <li
              id="empty"
              class="flex h-full w-full flex-col items-center items-center justify-center text-center"
            >
              <img
                class="mx-auto w-32"
        ...
        <footer class="flex justify-end px-8 pb-8 pt-4">
          <div class="modal-action" id="submit">
            <label for="upload-files" class="btn btn-outline">CLOSE</label>
          </div>
        </footer>
      </article>
    </main>
      ...
      >
        ...
        >
          ...
          <div class="flex">
            ...
            <button
              class="delete ml-auto rounded-md p-1 hover:bg-gray-300 focus:outline-none"
            >
              <svg
                class="pointer-events-none ml-auto h-4 w-4 fill-current"
                xmlns="http://www.w3.org/2000/svg"
